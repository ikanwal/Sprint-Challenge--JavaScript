...
const unisWithUni = [];
for(let i=0;i<graduates.length;i++){
  graduates[i].university.indexOf("Uni")>-1? unisWithUni.push(graduates[i].university) : 0;
}
...
zooAnimals.map(object=>lowCaseAnimalNames.push(object.animal_name.toLowerCase()))
...
populationTotal=zooAnimals.reduce((acc,currVal)=>{
